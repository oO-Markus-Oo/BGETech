...
class SDM72DMV2 extends BGETech
{
	...
	['Phase 3 active power', VARIABLETYPE_FLOAT, 'Watt.14490', 0x0010, 4, 2, true],
        ...
        ['Phase 1 power factor (1)', VARIABLETYPE_FLOAT, '', 0x001E, 4, 2, true],
        ['Phase 2 power factor (1)', VARIABLETYPE_FLOAT, '', 0x0020, 4, 2, true],
        ['Phase 3 power factor (1)', VARIABLETYPE_FLOAT, '', 0x0022, 4, 2, true],
	...
	['Total system power', VARIABLETYPE_FLOAT, 'Watt.14490', 0x0034, 4, 2, true],
        ...
        ['Total system power factor (1)', VARIABLETYPE_FLOAT, '', 0x003E, 4, 2, true],
	...
	['Total active Energy (2)', VARIABLETYPE_FLOAT, 'Electricity', 0x0156, 4, 2, true],
